              ...
              {loading ? (
                <div className="bg-gradient-to-br from-slate-100 dark:from-slate-900 to-slate-50 dark:to-slate-950 aspect-video rounded border border-slate-200 dark:border-slate-800 flex items-center justify-center">
                  <div className="text-center">
                    <p className="text-slate-600 dark:text-slate-400 text-sm">Loading featured project...</p>
                  </div>
                </div>
              ) : featuredProject ? (
                <motion.a
                  ...
                  className="block"
                >
                  <div className="bg-gradient-to-br from-slate-100 dark:from-slate-900 to-slate-50 dark:to-slate-950 aspect-video rounded border border-slate-200 dark:border-slate-800 hover:border-amber-500 dark:hover:border-amber-400 transition-all p-8 flex flex-col justify-between cursor-pointer group overflow-hidden relative">
                    {/* Accent line */}
                    ...
                    {/* Content */}
                    <div className="pl-4">
                      <p className="text-xs uppercase tracking-widest text-slate-600 dark:text-slate-400 font-semibold mb-3">
                        {featuredProject.language || 'Project'} • Featured
                      </p>
                      <h3 className="text-2xl font-bold mb-2 group-hover:text-gradient transition-colors text-black dark:text-white">
                ...
                <div className="bg-gradient-to-br from-slate-100 dark:from-slate-900 to-slate-50 dark:to-slate-950 aspect-video rounded border border-slate-200 dark:border-slate-800 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-slate-600 dark:text-slate-400 text-sm">Featured work unavailable</p>
                  </div>
                </div>
              )}
            </motion.div>
